...
export default function AdCarousel() {
  return (
    <section className="relative  w-[900px] mx-auto px-4 py-4 ">
      <Swiper
      ...
      >
        {slides.map((slide) => (
          <SwiperSlide key={slide.id}>
            <div className="relative max-height-[50px] w-full max-w-3xl mx-auto overflow-hidden rounded-xl">
              <img
                src={slide.img}
                alt={slide.title}
                /* width={100}
              ...
              <div className="absolute inset-0 bg-black/40 flex flex-col justify-center items-center text-white px-6 text-center">
                ...
                <button className="mt-4 bg-orange-500 hover:bg-orange-600 px-5 py-2 rounded-full text-white text-sm md:text-base shadow">
                  {slide.btnText}
                </button>
              </div>
            </div>
